...
<html>
    ...
    <body class="skin-blue" onload="fetchUsers(1)">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Manage User
                        <small>you can manage user here !!!</small>
                    </h1>
                    <ol class="breadcrumb">
                ...
                <section class="content">
                	  <div class="modal fade" id="myedituserModal" role="dialog">
                      <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form  class="form-horizontal" role="form">
                              <input type="hidden" name="Id" id="hid" value=""/>
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" style="width:50%; margin-left: 35%;margin-top: -5%;" id="edituser_name" class="form-control" required  readonly>
                                    </div>
                                  </div>
                                  <div class="form-group">
                          ...
                          <div class="form-group">        
                            <input type="submit" Value="Update Role" class="btn btn-warning btn-sm" style="margin-left:70%" onclick="updateAdminUserRole()" >
                          </div>
                        </div>
                      </div>
                    </div>

                    <div class="row" style="text-align: font-family: cursive;">
                      <table id="dataTableReport"  class="table table-bordered table-hover ">
                         <thead>
                            <tr class="bg-blue" style="display:block; width:100%;" >
