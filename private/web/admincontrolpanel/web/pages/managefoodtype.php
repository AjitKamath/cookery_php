                    ...
                    <div class="col-md-10" >
                      <span style="color: darkviolet;font-family: initial;"><?php $msg = isset($_GET['msg']) ? $_GET['msg'] : ''; echo $msg?></span><br>  
                          <form action="/private/web/admincontrolpanel/appcontext/controller.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <label class="control-label col-sm-2" >Type Image</label>
                                  <div class="col-sm-3">
                      ...
                      <div class="col-md-10">
                        <form>
                           ...
                           <div class="col-sm-3">
                            <input class="btn btn-primary btn-sm" onclick="multipleFoodTypeDelete('food_type_id');" type='submit' value='Delete'>
                           </div>
                      </div>
                  <br><br><hr>
