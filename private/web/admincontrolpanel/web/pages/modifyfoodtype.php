...
<html>
    ...
    <body class="skin-blue" onload="fetchFoodType(1)">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Modify Food Type
                        <small>you can modify food type here !!!</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li>Food Type</li>
												<li class="active">Modify Food Type</li>
                    </ol>
                </section>
                	...
                	<table id="dataTableReport"  class="table table-bordered table-hover" style="width: 100%;">
											<thead>
												<tr class="bg-blue" style="display:block;" >
													...
													<th style="width:38%; text-align:center;">Food Type</th>
									...
									<input class="btn btn-primary btn-sm" style="margin-left: 36%;margin-top: 3%;width: 25%;" id="btn-chat" onclick="multipleFoodTypeDelete('food_type_id');" type='submit' value='Delete Multiple'>
