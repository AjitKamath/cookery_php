...
<html>
    ...
    <body class="skin-blue" onload="fetchFoodCuisine(0)">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Add Food Cuisine
                        <small>you can add a food cuisine here !!!</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li>Food Cuisine</li>
												<li class="active">Add Food Cuisine</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="container" style="margin-top: 4%; margin-left: 2%;">
														...
														<div class="mycontent-left">
															...
															<table>
																		...
																		<td>
																				<div class="form-group">
																					<label class="control-label col-sm-4" >Cuisine Name</label>
																						<div class="col-sm-10">
																							<input type="text" style="width: 59%;margin-left: 50%;margin-top: -10%;" id="cuisine_name" class="form-control" required placeholder="Food Cuisine Name">
																						</div>
																				</div><br><br>
																		</td>
																	</tr>
																	<tr>
																		<td>
																				<div class="form-group">
																					<label class="control-label col-sm-6" >Cuisine Image</label>
																						<div class="col-sm-10">
																							<input type="file" id="cuisine_img" style="width:62%;margin-left: 50%;margin-top: -8%;" />
																						</div><br><br>
																				</div>
																		</td>
																	</tr>
																	<tr>
																		<td>
																			<input class="btn btn-success btn-sm" style="margin-left: 4%;margin-top: 5%;width: 83%;" id="btn-chat" onclick="saveCuisine();" type='submit' value='Save Cuisine'>
																		</td>
																	</tr>
																</table>
																</form>
													...
													<div class="col-md-6" style="width: 55%;">
														<table id="dataTableReport"  class="table table-bordered table-hover" style="margin-left:15%;width: 100%;">
															 	<thead>
																	<tr class="bg-blue" style="display:block;" >
																		...
																		<th style="width:70%; text-align:center;">Cuisine Name</th>
														...
														<input class="btn btn-primary btn-sm" style="margin-left: 48%;margin-top: 5%;width: 30%;" id="btn-chat" onclick="multipleFoodCuisineDelete('food_csn_id');" type='submit' value='Delete Multiple'>
													</div>
												</div>
                    </div>
                    <!-- /.row -->
