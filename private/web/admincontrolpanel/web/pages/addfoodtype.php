...
<html>
    ...
    <body class="skin-blue" onload="fetchFoodType(0)">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Add Food Type
                        <small>you can add a food type here !!!</small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="container" style="margin-top: 4%; margin-left: 2%;">
														...
														<div class="mycontent-left">
															...
															<table>
																	<tr>
																		<td>
																				<div class="form-group">
																					<label class="control-label col-sm-4" >Food Type Name</label>
																						<div class="col-sm-10">
																							<input type="text" style="width: 59%;margin-left: 50%;margin-top: -10%;" id="food_type_name" class="form-control" required placeholder="Food Type Name">
																						</div>
																				</div><br><br>
																		</td>
																	</tr>
																	<tr>
																		<td>
																				<div class="form-group">
																					<label class="control-label col-sm-6" >Food Type Image</label>
																						<div class="col-sm-10">
																							<input type="file" id="food_type_img" style="width:62%;margin-left: 50%;margin-top: -8%;" />
																						</div><br><br>
																				</div>
																		</td>
																	</tr>
																	<tr>
																		<td>
																			<input class="btn btn-success btn-sm" style="margin-left: 4%;margin-top: 5%;width: 83%;" id="btn-chat" onclick="saveFoodType();" type='submit' value='Save Food Type'>
																		</td>
																	</tr>
																</table>
																</form>
													...
													<div class="col-md-6" style="width: 55%;">
														<table id="dataTableReport"  class="table table-bordered table-hover" style="margin-left:15%;width: 100%;">
															 	<thead>
																	<tr class="bg-blue" style="display:block;" >
																		...
																		<th style="width:70%; text-align:center;">Food Type Name</th>
														...
														<input class="btn btn-primary btn-sm" style="margin-left: 48%;margin-top: 5%;width: 30%;" id="btn-chat" onclick="multipleFoodTypeDelete('food_type_id');" type='submit' value='Delete Multiple'>
													</div>
												</div>
                    </div>
                    <!-- /.row -->
													...
													<div class="modal-body">
														<form  class="form-horizontal" role="form">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-10">
																			<input type="text" style="width:50%;" id="food_type_name" class="form-control" required placeholder="Food Type Name">
																		</div>
																	</div>
																	<div class="form-group">        
