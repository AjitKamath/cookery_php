...
<html>
    ...
    <body class="skin-blue" onload="fetchFoodCuisine(1)">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Modify Food Cuisine
                        <small>you can modify food cuisine here !!!</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li>Food Cuisine</li>
												<li class="active">Modify Food Cuisine</li>
                    </ol>
                </section>
                	...
                	<table id="dataTableReport"  class="table table-bordered table-hover" style="width: 100%;">
											<thead>
												<tr class="bg-blue" style="display:block;" >
													...
													<th style="width:38%; text-align:center;">Food Cuisine</th>
									...
									<input class="btn btn-primary btn-sm" style="margin-left: 36%;margin-top: 3%;width: 25%;" id="btn-chat" onclick="multipleFoodCuisineDelete('food_csn_id');" type='submit' value='Delete Multiple'>
