...
?>
        ...
        <!-- Morris chart -->
        <link href="<?php echo CSS_PATH ?>/morris/morris.css" rel="stylesheet" type="text/css" />
        <!-- jvectormap -->
        <link href="<?php echo CSS_PATH ?>/jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        <!-- fullCalendar -->
        ...
        <link href="<?php echo CSS_PATH ?>/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        ...
        <!-- Bootstrap WYSIHTML5 -->
        <script src="<?php echo JS_PATH ?>/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
        <!-- iCheck -->
        ...
        <script src="<?php echo JS_PATH ?>/AdminLTE/dashboard.js" type="text/javascript"></script> 
        <!-- Custom script -->
        <script src="<?php echo JS_PATH ?>/customjs.js" type="text/javascript"></script>
        <!-- Bootbox script -->
        <script src="<?php echo JS_PATH ?>/bootbox.min.js" type="text/javascript"></script>