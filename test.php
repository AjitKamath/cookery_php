<?php
    ...
    $rcp_nm         = isset($_POST['rcp_nm']) ? $_POST['rcp_nm'] : 'abc';
    $food_csn_nm    = isset($_POST['food_csn_nm']) ? $_POST['food_csn_nm'] : '';
    $ing_id         = isset($_POST['ing_id']) ? $_POST['ing_id'] : '1';
    $ing_nm         = isset($_POST['ing_nm']) ? $_POST['ing_nm'] : 'test';
    $qty_id         = isset($_POST['qty_id']) ? $_POST['qty_id'] : '1';
    $ing_qty        = isset($_POST['ing_qty']) ? $_POST['ing_qty'] : '1';
    $rcp_proc       = isset($_POST['rcp_proc']) ? $_POST['rcp_proc'] : 'cvbn';
    $rcp_plating    = isset($_POST['rcp_plating']) ? $_POST['rcp_plating'] : '';
    $rcp_note       = isset($_POST['rcp_note']) ? $_POST['rcp_note'] : '';
    $tst_id         = isset($_POST['tst_id']) ? $_POST['tst_id'] : '1';
    $tst_qty        = isset($_POST['tst_qty']) ? $_POST['tst_qty'] : '1';
    $food_typ_id    = isset($_POST['food_typ_id']) ? $_POST['food_typ_id'] : '1';
